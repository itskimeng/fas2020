...
$objPHPExcel->setActiveSheetIndex()->setCellValue('B15','PR No. '.$pr_no.' date received:______');
$objPHPExcel->setActiveSheetIndex()->setCellValue('B16','PUR: '.$purpose);
...
//=================///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //=============///////////////////////////////////////////////////////////////////////     WIN 4     ////////////////////////////////////////////////////////////////////////////////////////
    $suppliers4 = mysqli_query($conn, "SELECT s.philgeps_reg_no, s.id,rq.rfq_id,sq.id,s.id as sid,s.supplier_title,s.supplier_address,s.contact_details,s.remarks FROM supplier s LEFT JOIN supplier_quote sq on sq.supplier_id = s.id LEFT JOIN rfq_items rq on rq.id = sq.rfq_item_id WHERE sq.rfq_item_id = $rid  AND s.supplier_title != '$supplier_title1' AND s.supplier_title != '$supplier_title2' AND s.supplier_title != '$supplier_title3'");
    $rowS4 = mysqli_fetch_assoc($suppliers4);
    $supplier_title4 = $rowS4['supplier_title'];
    $philgeps4 = $rowS4['philgeps_reg_no'];
    $sid4 = $rowS4['sid'];
    ...
    if ($rowabsno4 != NULL) {
      $objPHPExcel->getActiveSheet()->getStyle('I9')->applyFromArray($SelectedStyle);
      // $objPHPExcel->getActiveSheet()->getStyle('I15')->applyFromArray($SelectedStyle);
      // $objPHPExcel->getActiveSheet()->getStyle('J15')->applyFromArray($SelectedStyle);
    }

    $objPHPExcel->setActiveSheetIndex()->setCellValue('I9',$supplier_title4);
    $objPHPExcel->setActiveSheetIndex()->setCellValue('I22',$philgeps4);
  ...
  //=============///////////////////////////////////////////////////////////////////////     WIN 6     ////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ($rowabsno6 != NULL) {
      $objPHPExcel->getActiveSheet()->getStyle('K9')->applyFromArray($SelectedStyle);
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('K9',$supplier_title6);
...
while ($rowrfid1 = mysqli_fetch_assoc($select_rfid1)) 
{
    ...
    $objPHPExcel->setActiveSheetIndex()->setCellValue('F21','Passed');
    $objPHPExcel->setActiveSheetIndex()->setCellValue('F25','Passed');
    $objPHPExcel->setActiveSheetIndex()->setCellValue('F24','Passed');
    // $rowFirst++;
...
$totalABCperItem = $tots_sup['totalABCperItem'];
  ...
  $objPHPExcel->getActiveSheet()->getStyle('F'.$rowFirst)->applyFromArray($ALIGNRIGHT);
  // $objPHPExcel->getActiveSheet()->getStyle('I'.$rowFirst)->applyFromArray($ALIGNRIGHT);
  $objPHPExcel->setActiveSheetIndex()->setCellValue('F'.$rowFirst,number_format($totalABCperItem,2));
  $objPHPExcel->getActiveSheet()->getStyle('F'.$rowFirst)->applyFromArray($border);
...
while ($rowrfid2 = mysqli_fetch_assoc($select_rfid2)) {
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('G21','Passed');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('G25','Passed');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('G24','Passed');
  // $rowsecond++;
...
while ($rowrfid3 = mysqli_fetch_assoc($select_rfid3)) {
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValue('H21','Passed');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('H25','Passed');
  $objPHPExcel->setActiveSheetIndex()->setCellValue('H24','Passed');
  // $rowthird++;
