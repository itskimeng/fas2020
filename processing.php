            ...
            <div class="box">
                <div class="panel panel-default">
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <button class="btn btn-success"><a style = "color:#fff;decoration:none;" href="dash_ta_view.php?division=<?php echo $_GET['division'];?>&username=<?= $_GET['username'];?>"><i class = "fa fa-plus"></i>&nbsp;Create Request</a></button>
                         <a class = "btn btn-md btn-success" style="color:white;text-decoration: none;"  href = "dash_ta_monitoring.php?division=<?php echo $_GET['division'];?>" style="color:white;text-decoration: none;">Monitoring</a>
