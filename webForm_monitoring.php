...
require_once 'menu_checker.php';
  $menuchecker = menuChecker('web_posting'); 
    ...
    function countReceived($options)
    {
        ...
        $query = "SELECT count(*) as 'count' FROM tblwebposting WHERE STATUS  = '$options' || ASSIGN_DATE != '0000-00-00'  || POSTED_BY != '' || CONFIRMED_BY != ''";
    ...
    function countCompleted($options)
    {
        include ('connection.php');
        $query = "SELECT count(*) as 'count' FROM tblwebposting WHERE STATUS  = '$options' AND STATUS = 'Approved' ";
        $result = mysqli_query($conn, $query);
        if($row = mysqli_fetch_array($result))
        {
            echo $row['count'];
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12 col-xs-12" >
                                                <div class="info-box bg-gray" style = "height:auto;" >
                                                    <a href = "report/WEBPOSTING/pages/viewWebPost.php?id=<?php echo $row['CONTROL_NO']; ?>" style = "color:black;" title = "View ICT TA Form" >
                                                                    ...
                                                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                                                        <div class="info-box">
                                                                            ...
                                                                            <div class="info-box-content">
                                                                                ...
                                                                                <span class="info-box-number"><?php echo countCompleted('Completed');?></span>
                                                                            </div>
                                                                            <!-- /.info-box-content -->
                                                                        </div>
                                                                        <!-- /.info-box -->
