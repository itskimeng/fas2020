...
$objPHPExcel = PHPExcel_IOFactory::load("library/FM-QP-DILG-ISTMS-RO-17-03_ICT_TA.xlsx");
...
if (mysqli_num_rows($sql_q10)>0) 
{
  ...
  $objDrawingg->setPath('images/psl_sig2.PNG');

  $objDrawing->setCoordinates('E1');
  $objDrawingg->setCoordinates('B1');
                    
  //setOffsetX works properly
  $cur_row = $row+9;
  $cur_row2 = $row+18;
  $objDrawing->setCoordinates('E'.$cur_row);
  $objDrawingg->setCoordinates('B'.$cur_row2);//set image to cell             
  //set width, height
...
header('location: FM-QP-DILG-ISTMS-RO-17-03_ICT_TA.xlsx');
