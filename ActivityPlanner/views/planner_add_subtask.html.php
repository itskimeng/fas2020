<?php require_once 'ActivityPlanner/controller/ActivitySubtaskController.php'; ?>

<div class="content-wrapper">
  <section class="content-header">
    <h1>Task Management <small>Add Task</small></h1>
    <ol class="breadcrumb">
      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">LGCDD</a></li>
      <li><a href="base_task_management.html.php?division=<?php echo $_SESSION['division'];?>">Task Management</a></li>
        ...
        <div class="box box-primary dropbox">
          ...
          <div class="box-body">
            <div class="col-md-12">
              ...
              <p class="text-muted"><?php echo $event_data['event_venue']; ?></p>
              
              <hr>
              <strong><i class="fa fa-users margin-r-5"></i>Target Participants</strong>
              <p class="text-muted"><?php echo $event_data['target_participants']; ?></p>

              <hr>
              <strong><i class="fa fa-pencil margin-r-5"></i> Priority Level</strong>
              <p><?php echo group_rateme('Priority','priority', $event_data['event_priority'], 0); ?></p>
            </div>
          </div>
        </div>
      </div>
