					...
					<div class="col-md-12 bottom text-center">
                    	<div class="row">
	                        ...
	                        <div class="col-md-12 emphasis">
	                            ...
	                            <?php if ($task['multiple_collab']): ?>
	                            	<button type="button" id="show-collaborators" class="btn btn-warning btn-xs show-ongoing_collaborators slide-left" title="View Collaborators" data-value="details"> 
