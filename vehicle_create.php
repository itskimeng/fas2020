        ...
        <table class="table">
          ...
          <tr>
            ...
            <td class="col-md-2 " style=" border:1px solid black; text-align:left; ">
              <input readonly required type="text" class="" style=" text-align:left; border:none;border-bottom:1px solid black; font-weight:bold; font-size:15px; height: 30px; width:100%;" name="vrdate" id="vrdate" value="<?php date_default_timezone_set('Asia/Manila');
                                                                                                                                                                                                                              echo date('F d, Y') ?>">
            ...
            <td class="col-md-1 " style=" border:1px solid black; text-align:left; ">
              ...
              <input readonly required type="text" class="" style=" text-align:left; border:none;border-bottom:1px solid black; font-weight:bold; font-size:15px; height: 30px; width:100%;" name="vrtime" id="" value="<?php date_default_timezone_set('Asia/Manila');
                                                                                                                                                                                                                        echo date('h:i A') ?>">
            </td>
          ...
          <tr>
            ...
            <td class="col-md-1" style=" border:1px solid black; text-align:center; ">
              <input autocomplete="off" required type="time" class="" style="border:none;border-bottom:1px solid black; font-weight:bold; height: 35px; width:100%;" name="departuretime" id="departuretime" value="<?php echo isset($_POST['departuretime']) ? htmlspecialchars($_POST['departuretime'], ENT_QUOTES) : ''; ?>">
            </td>
            </td>
            <!--  Departure Time: -->
          ...
          <tr>
            ...
            <td class="col-md-1" style=" border:1px solid black; text-align:center; ">
              <input autocomplete="off" required type="time" class="" style="border:none;border-bottom:1px solid black; font-weight:bold; height: 35px; width:100%;" name="returntime" id="returntime" value="<?php echo isset($_POST['returntime']) ? htmlspecialchars($_POST['returntime'], ENT_QUOTES) : ''; ?>">
            </td>
            </td>
            <!--  Return Time: -->
