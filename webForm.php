...
<html>
    ...
    <body class="hold-transition skin-red-light fixed sidebar-mini">
        <div class="wrapper">
        <?php 
  if ($username == 'charlesodi' || $username == 'mmmonteiro' || $username == 'cvferrer' || $username == 'masacluti' || $username == 'magonzales' || $username == 'seolivar' || $username == 'jamonteiro') { include('test1.php'); 
  }else{ 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="col-md-12">
                                    <div class="box box-primary direct-chat direct-chat-primary">
                                        <div class="box-header with-border">
                                            <h1 class="box-title">URL Decoder</h1>
                                        </div>
                                        <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-lg btn-success" style="width:100%;outline:none;">
                                        <i class="fa fa-task"></i>
                                        <a href="webForm_monitoring.php" style="color:#fff;">Monitoring</a>
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="box box-primary direct-chat direct-chat-primary">
                                    <div class="box-body">
                                        ...
                                        <form
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="padding:2%;">
                                                    <div class="col-lg-12">
                                                        <table
                                                            border="1"
                                                            style="table-layout: fixed; width:100%;border-width:medium;border-style:solid black;"
                                                            id="table_name">
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="time" class="form-control timepicker" name="requested_time">
                                                                    </td>
                                                                    <td class="tdTitle" rowspan="3" style="text-align:center;">Category</td>
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input type="checkbox" class="checkbox_group" name="chk_category" value="News">
                                                                        News</td>
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input
                                                                        type="checkbox"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input type="checkbox" class="checkbox_group" name="chk_category" value="LGUs">
                                                                        LGUs</td>
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input
                                                                        type="checkbox"
                                                                        class="checkbox_group"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input type="checkbox" class="checkbox_group" name="chk_category" value="Photo">
                                                                        Photo</td>
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input type="checkbox" class="checkbox_group" name="chk_category" value="Video">
                                                                        Video</td>
                                                                    <td style="font-family:'Cambria';font-weight:bold;"><input type="checkbox" class="checkbox_group" name="chk_category" value="Forms">
                                                                        Forms</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="time" disabled="disabled" class="form-control timepicker_received">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group date">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                disabled="disabled"
                                                                                class="form-control pull-right"
                                                                                id="datepicker_posted">
                                                                        </div>
                                                                    </td>
                                                                    <td class="tdTitle">Posted Time:</td>
                                                                    <td>
                                                                        <input type="time" disabled="disabled" class="form-control timepicker-posted">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <textarea disabled="disabled" style="resize:none;" cols="58">POSTED WITH NO ERROR</textarea>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="8" style="border:3px solid black;"></td>
                                            ...
                                            <button
                                                type="button"
                                                class="btn btn-primary btn-lg sweet-14"
                                                style="float: right; margin:10px;outline:none;"
                                                onclick="return confirm('Are you sure you want to save now?');"
                                                id="finalizeButton">
