...
// $ra['05'] = isset($rate[4]) ? $rate[4] : '';

$id['0'] = isset($qme_id[0]) ? $qme_id[0] : '';
$id['1'] = isset($qme_id[1]) ? $qme_id[1] : '';
$id['2'] = isset($qme_id[2]) ? $qme_id[2] : '';
$id['3'] = isset($qme_id[3]) ? $qme_id[3] : '';
$id['4'] = isset($qme_id[4]) ? $qme_id[4] : '';
// $id['5'] = isset($qme_id[4]) ? $qme_id[5] : '';
// $id = 0;
$ind = array();
$ratee = array();
...
for ($i = 0; $i <= count($rr); $i++){
	...
	$e['05'] = isset($ratee[$i][5]) ? $ratee[$i][5] : '';
