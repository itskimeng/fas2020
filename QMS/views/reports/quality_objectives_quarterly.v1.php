...
<?php if ($data['indicator_a'] != ''): $ob_label = 'B'; ?>
	...
	<div class="col-md-12">
		<form action="QMS/route/update_qms_qme_quarterly.php?parent=<?= $_GET['parent']; ?>&qoe_id=<?= $_GET['id']; ?>&id=<?= $frequencies[0]['id']; ?>&entry_id=<?php echo $_GET['entry_id']; ?>&indicator=<?php echo $frequencies[0]['indicator']; ?>&year=<?php echo $frequencies[0]['year']; ?>" method="POST">
						...
						<td class="text-center">
							...
							<?php else: ?>
								<?php if (!empty($frequencies[0]['is_na']['01'])): ?>
									<?= group_textnew('Rate', 'rate[0]',  isset($frequencies) ? $frequencies[0]['rate']['01'] : '', 'rate', $qp_covered['qp_covered'] != '1st Quarter' ? true : false, 0); ?>
								<?php else: ?>
						...
						<td>
							...
							<?php else: ?>	
								<?php if (!empty($frequencies[0]['is_na']['02'])): ?>
									<?= group_textnew('Rate', 'rate[1]',  isset($frequencies) ? $frequencies[0]['rate']['02'] : '', 'rate', $qp_covered['qp_covered'] != '2nd Quarter' ? true : false, 0); ?>
								<?php else: ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[0]['is_na']['03'])): ?>
									<?= group_textnew('Rate', 'rate[2]',  isset($frequencies) ? $frequencies[0]['rate']['03'] : '', 'rate', $qp_covered['qp_covered'] != '3rd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[0]['is_na']['04'])): ?>
									<?= group_textnew('Rate', 'rate[3]',  isset($frequencies) ? $frequencies[0]['rate']['04'] : '', 'rate', $qp_covered['qp_covered'] != '4th Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td class="text-center">
							...
							<?php else: ?>
								<?php if (!empty($frequencies[1]['is_na']['01'])): ?>
									<?= group_textnew('Rate', 'rate[0]',  isset($frequencies) ? $frequencies[1]['rate']['01'] : '', 'rate', $qp_covered['qp_covered'] != '1st Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-ban"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>	
								<?php if (!empty($frequencies[1]['is_na']['02'])): ?>
									<?= group_textnew('Rate', 'rate[1]',  isset($frequencies) ? $frequencies[1]['rate']['02'] : '', 'rate', $qp_covered['qp_covered'] != '2nd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[1]['is_na']['03'])): ?>
									<?= group_textnew('Rate', 'rate[2]',  isset($frequencies) ? $frequencies[1]['rate']['03'] : '', 'rate', $qp_covered['qp_covered'] != '3rd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[1]['is_na']['04'])): ?>
									<?= group_textnew('Rate', 'rate[3]',  isset($frequencies) ? $frequencies[1]['rate']['04'] : '', 'rate', $qp_covered['qp_covered'] != '4th Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td class="text-center">
							...
							<?php else: ?>
								<?php if (!empty($frequencies[2]['is_na']['01'])): ?>
									<?= group_textnew('Rate', 'rate[0]',  isset($frequencies) ? $frequencies[2]['rate']['01'] : '', 'rate', $qp_covered['qp_covered'] != '1st Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-ban"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>	
								<?php if (!empty($frequencies[2]['is_na']['02'])): ?>
									<?= group_textnew('Rate', 'rate[1]',  isset($frequencies) ? $frequencies[2]['rate']['02'] : '', 'rate', $qp_covered['qp_covered'] != '2nd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[2]['is_na']['03'])): ?>
									<?= group_textnew('Rate', 'rate[2]',  isset($frequencies) ? $frequencies[2]['rate']['03'] : '', 'rate', $qp_covered['qp_covered'] != '3rd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[2]['is_na']['04'])): ?>
									<?= group_textnew('Rate', 'rate[3]',  isset($frequencies) ? $frequencies[2]['rate']['04'] : '', 'rate', $qp_covered['qp_covered'] != '4th Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td class="text-center">
							...
							<?php else: ?>
								<?php if (!empty($frequencies[3]['is_na']['01'])): ?>
									<?= group_textnew('Rate', 'rate[0]',  isset($frequencies) ? $frequencies[3]['rate']['01'] : '', 'rate', $qp_covered['qp_covered'] != '1st Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-ban"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>	
								<?php if (!empty($frequencies[3]['is_na']['02'])): ?>
									<?= group_textnew('Rate', 'rate[1]',  isset($frequencies) ? $frequencies[3]['rate']['02'] : '', 'rate', $qp_covered['qp_covered'] != '2nd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[3]['is_na']['03'])): ?>
									<?= group_textnew('Rate', 'rate[2]',  isset($frequencies) ? $frequencies[3]['rate']['03'] : '', 'rate', $qp_covered['qp_covered'] != '3rd Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
						...
						<td>
							...
							<?php else: ?>
								<?php if (!empty($frequencies[3]['is_na']['04'])): ?>
									<?= group_textnew('Rate', 'rate[3]',  isset($frequencies) ? $frequencies[3]['rate']['04'] : '', 'rate', $qp_covered['qp_covered'] != '4th Quarter' ? true : false, 0); ?>
								<?php else: ?>
									<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
								<?php endif ?>
							<?php endif ?>
				...
				<tr style="font-size: 11px; background-color: #b8b8b8a3;">
					<th class="text-center" width="7.5%">
						...
						<div class="switchToggle">
						    ...
						    <input type="checkbox" id="switch1-indicator_e" name="is_na[01]" <?= isset($frequencies) ? (($frequencies[4]['is_na']['01'] == 'y')  ? 'checked' : '') : ''; ?> <?php if ($qp_covered['qp_covered'] != '1st Quarter'){ echo 'onclick="return false;"'; } ?>>
					...
					<th class="text-center" width="7.5%">
						...
						<div class="switchToggle">
						    ...
						    <input type="checkbox" id="switch2-indicator_e" name="is_na[02]" <?= isset($frequencies) ? (($frequencies[4]['is_na']['02'] == 'y')  ? 'checked' : '') : ''; ?> <?php if ($qp_covered['qp_covered'] != '2nd Quarter'){ echo 'onclick="return false;"'; } ?>>
					...
					<th class="text-center" width="7.5%">
						...
						<div class="switchToggle">
						    ...
						    <input type="checkbox" id="switch3-indicator_e" name="is_na[03]" <?= isset($frequencies) ? (($frequencies[4]['is_na']['03'] == 'y')  ? 'checked' : '') : ''; ?> <?php if ($qp_covered['qp_covered'] != '3rd Quarter'){ echo 'onclick="return false;"'; } ?>>
					...
					<th class="text-center" width="7.5%">
						...
						<div class="switchToggle">
						    ...
						    <input type="checkbox" id="switch4-indicator_e" name="is_na[04]" <?= isset($frequencies) ? (($frequencies[4]['is_na']['04'] == 'y')  ? 'checked' : '') : ''; ?> <?php if ($qp_covered['qp_covered'] != '4th Quarter'){ echo 'onclick="return false;"'; } ?>>
					...
					<td class="text-center">
						...
						<?php else: ?>
							<?php if (!empty($frequencies[4]['is_na']['01'])): ?>
								<?= group_textnew('Rate', 'rate[0]',  isset($frequencies) ? $frequencies[4]['rate']['01'] : '', 'rate', $qp_covered['qp_covered'] != '1st Quarter' ? true : false, 0); ?>
							<?php else: ?>
								<span><i class="fa fa-ban"></i></span>
							<?php endif ?>
						<?php endif ?>
					...
					<td>
						...
						<?php else: ?>	
							<?php if (!empty($frequencies[4]['is_na']['02'])): ?>
								<?= group_textnew('Rate', 'rate[1]',  isset($frequencies) ? $frequencies[4]['rate']['02'] : '', 'rate', $qp_covered['qp_covered'] != '2nd Quarter' ? true : false, 0); ?>
							<?php else: ?>
								<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
							<?php endif ?>
						<?php endif ?>
					...
					<td>
						...
						<?php else: ?>
							<?php if (!empty($frequencies[4]['is_na']['03'])): ?>
								<?= group_textnew('Rate', 'rate[2]',  isset($frequencies) ? $frequencies[4]['rate']['03'] : '', 'rate', $qp_covered['qp_covered'] != '3rd Quarter' ? true : false, 0); ?>
							<?php else: ?>
								<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
							<?php endif ?>
						<?php endif ?>
					...
					<td>
						...
						<?php else: ?>
							<?php if (!empty($frequencies[4]['is_na']['04'])): ?>
								<?= group_textnew('Rate', 'rate[3]',  isset($frequencies) ? $frequencies[4]['rate']['04'] : '', 'rate', $qp_covered['qp_covered'] != '4th Quarter' ? true : false, 0); ?>
							<?php else: ?>
								<span><i class="fa fa-2x fa-ban" style="color:#dd4b39;"></i></span>
							<?php endif ?>
						<?php endif ?>
