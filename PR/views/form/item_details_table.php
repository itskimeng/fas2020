<div class="box item-list-table box-primary box-solid dropbox" style="height:500px;">
    ...
    <div class="box-header with-border">
      <div class="row" class="box-body box-emp">
        ...
        <div class="col-lg-6">
          ...
          <textarea id="desc" rows="1" cols="70" class="form-control" style="resize:none;outline:none;" name="description"></textarea>


          <label>Unit Cost <font style="color: Red;">*</font></label>
          <br>
          <input class="form-control" type="text" id="abc" name="abc" readonly>
          <input input type="hidden" class="form-control" type="text" id="total_cost" name="total" readonly>
          <input input type="hidden" class="form-control" type="text" id="items1" name="items1" readonly>
