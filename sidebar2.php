            ...
            <ul class="treeview-menu" >
              ...
              <?php if (in_array(3, $arrayModuleId)) : ?>
                ...
                <li class = <?php if($menuchecker['databank']) echo 'active';?>>
                  <a href="databank.php?division=<?php echo $param1;?>"   >
                    <i class="fa fa-archive" ></i>Databank
              ...
              <?php if (in_array(4, $arrayModuleId)) : ?>
                ...
                <li class = <?php if($menuchecker['issuances']) echo 'active';?>>
                    <a href="issuances.php?division=<?php echo $param1;?>"  ><i class="fa" >&#xf0f6;</i>Issuances
              ...
              <?php if (in_array(5, $arrayModuleId)) : ?>
                ...
                <li class = <?php if($menuchecker['phone_directory']) echo 'active';?>>
                  <a href="Directory.php?division=<?php echo $param1;?>"   >
                    <i class="fa fa-archive" ></i>Directory
                  </a>
                </li>
                <!-------------------------------------------- DIRECTORY ------------------------------------------->
              <?php endif ?>
                  ...
                  <ul class="treeview-menu">
                      ...
                      <!-------------------------------------------- DTR ------------------------------------------->
                        <?php if ($_SESSION['OFFICE_STATION'] == 1 || $_SESSION['OFFICE_STATION'] == 2): ?>
                          <li class ="<?php if( $menuchecker['dailytimerecord']) echo 'active' ?>">
                            <a href="dailytimerecord.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  >
                              <i class="fa fa-calendar-times-o" ></i>My DTR
                            </a>
                          </li>
                        <?php else: ?>
                          <li class ="<?php if( $menuchecker['dtr']) echo 'active' ?>">
                            <a href="DTR.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  >
                              <i class="fa fa-calendar-times-o" ></i>My DTR
                            </a>
                          </li>
                        <?php endif ?>
                      ...
                      <?php if ($username == 'gltumamac' || $username == 'mmmonteiro' || $username == 'pmmendoza' || $username == 'hpsolis' || $username == 'magonzales' || $username == 'jtbeltran' || $username == 'cscruz' || $username == 'rbnanez' || $username == 'assangel' || $username == 'jvnadal' || $username == 'aasalvatus' || $username == 'masacluti' || $username == 'epdeluna'): ?>
                        <li class ="<?php if( $menuchecker['dtra']) echo 'active' ?>">
                          <a href="DtrMonitoring.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  >
                            <i class="fa fa-clock-o" ></i>DTR Monitoring
                          </a>
                        </li>
                      <?php endif ?>
                      <!-------------------------------------------- DTR MONITORING ------------------------------------------->
                      ...
                      <?php if (in_array($_SESSION['username'], ['jbaco', 'mmmonteiro', 'hpsolis', 'jecastillo','jvmagcayang', 'ccmontoya', 'fmingel', 'jccruz', 'eltomaclas', 'jvmbautista', 'jafermanez', 'jtdemin', 'ttbenabon', 'mvjasul', 'kpcastillo', 'levillena','epdeluna'])): ?>
                        <li class ="<?php if( $menuchecker['upload_dtr']) echo 'active' ?>">
                          <a href="upload_dtr.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  >
                            <i class="fa fa-upload" ></i>DTR Generation <b>(PO & RO)</b>
                          </a>
                        </li>
                        ...
                        <li class ="<?php if( $menuchecker['upload_dtr1']) echo 'active' ?>">
                          <a href="https://drive.google.com/file/d/1IPQtOvjCoNiMBSoDVroVMZVhbrkB2hqx/view?usp=sharing" target="_blank"  >
                            <i class="fa fa-link" ></i>DTR Manual
...
<!--                 <?php if (in_array($_SESSION['username'], ['jbaco', 'mmmonteiro', 'hpsolis', 'jecastillo'])): ?>
                <li class="treeview <?php if ($menuchecker['upload_dtr'] OR $menuchecker['export_dtr']) echo 'menu-open active'; ?>">
                  ...
                  <ul class="treeview-menu">
                    <li class ="<?php if( $menuchecker['upload_dtr']) echo 'active' ?>">
                      <a href="upload_dtr.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  >
                        <i class="fa fa-upload" ></i>Import DTR
                      </a>
                    </li>
                  </ul>
                </li>
                ...
                <li class ="<?php if( $menuchecker['ro_and_roo']) echo 'active' ?>">
                  <a href="ROandROO.php?division=<?php echo $param1;?>"   >
                    <i class="fa fa-archive" ></i>RO and ROO
                  </a>
                </li>
                <!-------------------------------------------- RO & ROO ------------------------------------------->
                <?php endif ?>
                ...
                <li class ="<?php if( $menuchecker['official_business']) echo 'active' ?>">
                  <a href="ob.php?division=<?php echo $param1;?>"  >
                    <i class="fa fa-user" ></i>Official Business
                  </a>
                </li>
                <!-------------------------------------------- OFFICIAL BUSINESS ------------------------------------------->
                <?php endif ?>
                ...
                <li class ="<?php if( $menuchecker['travel_order']) echo 'active' ?>">
                  <a href="TravelOrder.php?division=<?php echo $param1;?>"   >
                    <i class="fa fa-archive" ></i>Travel Order
                  </a>
                </li>
                <!-------------------------------------------- TRAVEL ORDER ------------------------------------------->
                <?php endif ?>
                ...
                <li class="treeview <?php if( $menuchecker['health_monitoring']) echo 'menu-open active';?>">
                  ...
                  <ul class="treeview-menu" >
                    ...
                    <!-------------------------------------------- DECLARATION FORM ------------------------------------------->
                    <li class ="<?php if( $menuchecker['health_declaration_form']) echo 'active' ?>"><a href="HealthMonitoring.php?action=show&username=<?php echo $username;?>&division=<?php echo $param1;?>"><i class="fa fa-copy" ></i>Health Declaration Form</a></li>
                    <!-------------------------------------------- DECLARATION FORM ------------------------------------------->
                    <?php endif ?>

                    <?php if (in_array(14, $arrayModuleId)) : ?>
                    <!-------------------------------------------- MONITORING ------------------------------------------->
                    <li class ="<?php if( $menuchecker['health_monitoring']) echo 'active' ?>"><a href="HealthMonitoring.php?username=<?php echo $username;?>&division=<?php echo $param1;?>"><i class="fa fa-copy" ></i>Health Monitoring</a></li>
                    <!-------------------------------------------- MONITORING ------------------------------------------->
                    <?php endif ?>
                  </ul>
                </li>
          ...
          <li class ="treeview <?php if ($baseurl['ViewApp.php'] || $baseurl['ViewPR.php'] || $baseurl['UpdateAPP.php'] || $baseurl['ViewApp_History.php'] || $baseurl['CreateAPP.php'] || $baseurl['CreatePR.php'] ||  $baseurl['ViewPRv.php'] || $baseurl['ViewRFQdetails.php'] || $baseurl['ViewUpdateRFQ.php'] || $baseurl['ViewRFQ.php'] || $baseurl['CreateRFQ.php'] || $baseurl['CreateAoq.php']  || $baseurl['ViewSuppliers.php'] || $baseurl['CreateSuppliers.php'] || $baseurl['UpdateSuppliers.php'] || $baseurl['UpdateSuppliers.php'] || $baseurl['stocks.php'] || $baseurl['CreateStocks.php'] || $baseurl['@stockledger.php'] || $baseurl['ViewIAR.php'] || $baseurl['UpdateIAR.php'] || $baseurl['CreateIAR.php'] || $baseurl['ViewRIS.php'] || $baseurl['CreateRIS.php']||$baseurl['UpdateRIS.php'] || $baseurl['ViewRPCI.php'] || $baseurl['UpdateRPCI.php'] || $baseurl['CreateRPCI.php'] || $baseurl['ViewRPCPPE.php'] || $baseurl['CreateRPCPPE.php'] || $baseurl['ViewPPE.php'] || $baseurl['VehicleRequest.php'] || $baseurl['VehicleRequestCreate.php']) echo 'menu-open active'; ?>" >
              ...
              <ul class="treeview-menu" > <li class = "treeview <?php if ($baseurl['ViewApp.php'] || $baseurl['ViewPR.php'] || $baseurl['UpdateAPP.php'] || $baseurl['ViewApp_History.php'] || $baseurl['CreateAPP.php'] || $baseurl['CreatePR.php'] || $baseurl['ViewPRv.php'] || $baseurl['ViewRFQdetails.php']|| $baseurl['ViewUpdateRFQ.php'] || $baseurl['ViewRFQ.php'] || $baseurl['CreateRFQ.php'] || $baseurl['CreateAoq.php'] || $baseurl['ViewSuppliers.php']|| $baseurl['CreateSuppliers.php'] || $baseurl['UpdateSuppliers.php']  ) echo 'menu-open';?>">
                  ...
                  <ul class="treeview-menu" style = " <?php if ($baseurl['ViewApp.php'] || $baseurl['ViewPR.php'] || $baseurl['UpdateAPP.php'] || $baseurl['ViewApp_History.php'] || $baseurl['CreateAPP.php'] || $baseurl['CreatePR.php'] || $baseurl['ViewPRv.php'] || $baseurl['ViewRFQdetails.php'] || $baseurl['ViewUpdateRFQ.php'] || $baseurl['ViewRFQ.php'] || $baseurl['CreateRFQ.php'] || $baseurl['CreateAoq.php'] || $baseurl['ViewSuppliers.php'] || $baseurl['CreateSuppliers.php'] || $baseurl['UpdateSuppliers.php'] ) echo 'display:block;';?>">
                    ...
                    <!------------------------------------- APP ------------------------------------------->
                    <li class = "<?php if ($baseurl['ViewApp.php'] || $baseurl['UpdateAPP.php'] || $baseurl['ViewApp_History.php'] || $baseurl['CreateAPP.php']) echo 'active';?>"><a href="procurement_app.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i> APP</a></li>
                    <!------------------------------------- APP ------------------------------------------->
                    <?php endif ?>

                    <?php if (in_array(18, $arrayModuleId)) : ?>
                    <!------------------------------------- PURCHASE REQUEST ------------------------------------------->
                    <li class = "<?php if($baseurl['ViewPR.php'] || $baseurl['CreatePR.php'] || $baseurl['ViewRFQdetails.php'] || $baseurl['ViewUpdateRFQ.php'] ) echo 'active';?>"><a href="procurement_purchase_request.php?quarter=3&division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i> Purchase Request</a></li>
                    <!------------------------------------- PURCHASE REQUEST ------------------------------------------->
                    <?php endif ?>

                    <?php if (in_array(19, $arrayModuleId)) : ?>
                    <!------------------------------------- QUOTATION ------------------------------------------->
                    <li class = "<?php if($baseurl['ViewRFQ.php'] || $baseurl['CreateRFQ.php'] || $baseurl['CreateAoq.php']) echo 'active';?>"><a href="procurement_request_for_quotation.php?division=<?php echo $param1;?>"  ><i class="fa" >&#xf0f6;</i> Request for Quotation</a></li>
                    <!------------------------------------- QUOTATION ------------------------------------------->
                    <?php endif ?>

                    <?php if (in_array(20, $arrayModuleId)) : ?>
                    <!------------------------------------- SUPPLIER ------------------------------------------->
                    <li class = "<?php if($baseurl['ViewSuppliers.php'] ||  $baseurl['CreateSuppliers.php'] || $baseurl['UpdateSuppliers.php']) echo 'active';?>" ><a href="ViewSuppliers.php"><i class="fa" >&#xf0f6;</i><span>Supplier</span></a></li>
                    <!------------------------------------- SUPPLIER ------------------------------------------->
                    <?php endif ?>
                  ...
                  <li class="treeview <?php if( $baseurl['stocks.php'] || $baseurl['CreateStocks.php'] || $baseurl['@stockledger.php'] || $baseurl['ViewIAR.php'] || $baseurl['UpdateIAR.php'] || $baseurl['ViewRIS.php'] || $baseurl['CreateRIS.php'] || $baseurl['UpdateRIS.php'] || $baseurl['ViewRPCI.php'] || $baseurl['UpdateRPCI.php'] || $baseurl['CreateRPCI.php'] || $baseurl['ViewRPCPPE.php'] || $baseurl['CreateRPCPPE.php'] || $baseurl['ViewPPE.php'] || $baseurl['VehicleRequest.php'] || $baseurl['VehicleRequestCreate.php']) echo 'menu-open';?>">
                    ...
                    <ul class="treeview-menu" style = "<?php if( $baseurl['stocks.php'] || $baseurl['CreateStocks.php'] || $baseurl['@stockledger.php'] || $baseurl['ViewIAR.php'] || $baseurl['UpdateIAR.php'] || $baseurl['ViewRIS.php'] || $baseurl['CreateRIS.php'] || $baseurl['UpdateRIS.php'] || $baseurl['ViewRPCI.php'] || $baseurl['UpdateRPCI.php'] || $baseurl['CreateRPCI.php'] || $baseurl['ViewRPCPPE.php'] || $baseurl['CreateRPCPPE.php'] || $baseurl['ViewPPE.php'] || $baseurl['VehicleRequest.php'] || $baseurl['VehicleRequestCreate.php']) echo 'display:block;'; ?>" >
                      ...
                      <!------------------------------------- STOCK CARD ------------------------------------------->
                      <li class = "<?php if($baseurl['stocks.php'] || $baseurl['CreateStocks.php']) echo 'active';?>"><a href="stocks.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i> Stock Card</a></li>
                      <!------------------------------------- STOCK CARD ------------------------------------------->
                      <?php endif ?>

                      <?php if (in_array(23, $arrayModuleId)) : ?>
                      <!------------------------------------- LEDGER CARD ------------------------------------------->
                      <li class = "<?php if($baseurl['@stockledger.php'] ) echo 'active';?>"><a href="@stockledger.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>Supplies Ledger Card</a></li>
                      <!------------------------------------- LEDGER CARD ------------------------------------------->
                      <?php endif ?>
                      ...
                      <!------------------------------------- IAR ------------------------------------------->
                      <li class = "<?php if($baseurl['UpdateIAR.php'] || $baseurl['ViewIAR.php'] || $baseurl['CreateIAR.php']) echo 'active';?>"><a href="dash_iar_view.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i> IAR</a></li>
                      <!------------------------------------- IAR ------------------------------------------->
                      <?php endif ?>

                      <?php if (in_array(25, $arrayModuleId)) : ?>
                      <!------------------------------------- RIS ------------------------------------------->
                      <li class = "<?php if($baseurl['ViewRIS.php'] || $baseurl['CreateRIS.php'] || $baseurl['UpdateRIS.php']) echo 'active';?>"><a href="ViewRIS.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>RIS</a></li>
                      <!------------------------------------- RIS ------------------------------------------->
                      <?php endif ?>

                      <?php if (in_array(26, $arrayModuleId)) : ?>
                      <!------------------------------------- ICS ------------------------------------------->
                      <li class = "<?php if($baseurl['ViewRPCI.php'] || $baseurl['UpdateRPCI.php'] || $baseurl['CreateRPCI.php'])echo 'active';?>"><a href="ViewRPCI.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>ICS</a></li>
                      <!------------------------------------- ICS ------------------------------------------->
                      <?php endif ?>

                      <?php if (in_array(27, $arrayModuleId)) : ?>
                      <!------------------------------------- PAR ------------------------------------------->
                      <li class = "<?php if($baseurl['ViewRPCPPE.php'] || $baseurl['CreateRPCPPE.php'] || $baseurl['ViewPPE.php']) echo 'active';?>"><a href="ViewRPCPPE.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>PAR</a></li>
                      <!------------------------------------- PAR ------------------------------------------->
                      <?php endif ?>
                  ...
                  <li class = "<?php if($baseurl['VehicleRequest.php'] || $baseurl['VehicleRequestCreate.php']) echo 'active';?>">
                    <a href="VehicleRequest.php?division=<?php echo $param1;?>"   >
                      <i class="fa fa-archive" ></i>Vehicle Request
                    </a>
                  </li>
                  <!------------------------------------- VEHICLE REQUEST ------------------------------------------->
                  <?php endif ?>
                  ...
                  <ul class="treeview-menu">
                    <li class="treeview <?php if($menuchecker['finance_fundsource'] || $menuchecker['saro'] || $menuchecker['ors_burs'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create'] || $menuchecker['view_burs'] || $menuchecker['finance_obligation']) echo 'menu-open active';?>">
                      ...
                      <ul class="treeview-menu <?php if($menuchecker['finance_fundsource'] || $menuchecker['ors_burs'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create'] || $menuchecker['finance_obligation']) echo 'menu-open active';?>">
                        ...
                        <li class = "<?php if($menuchecker['finance_fundsource'] || $menuchecker['saro'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create']) echo 'active';?>"><a href="budget_fundsource.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> Fund Source</a></li>
                        ...
                        <li class = "<?php if($menuchecker['finance_obligation'] || $menuchecker['view_burs']) echo 'active';?>"><a href="budget_obligation.php?page=1&ipp=10&division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> Obligation</a></li>
                        <!-------------------------------------------- ORS/BURS ------------------------------------------->
                        <?php endif ?>
              ...
              <li class="treeview <?php if($menuchecker['dv'] || $menuchecker['dv_update']|| $menuchecker['dv_process'] ||  $menuchecker['dv_create'] || $menuchecker['nta'] || $menuchecker['nta_create'] || $menuchecker['nta_update'] || $menuchecker['nta_view'] ) echo 'active';?>">
                ...
                <ul class="treeview-menu  <?php if($menuchecker['dv'] ||  $menuchecker['dv_create'] || $menuchecker['dv_process']|| $menuchecker['nta'] || $menuchecker['nta_update'] || $menuchecker['nta_view'] ) echo 'menu-open active';?>">
                  ...
                  <!-------------------------------------------- NTA/NCA ------------------------------------------->
                  <li class = "<?php if($menuchecker['nta'] || $menuchecker['nta_create'] || $menuchecker['nta_update'] || $menuchecker['nta_view'] ) echo 'active';?>"><a href="accounting_nta.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>NTA/NCA</a></li>
                  <!-------------------------------------------- NTA/NCA ------------------------------------------->
                  <?php endif ?>

                  <?php if ( in_array(35, $arrayModuleId) ) : ?>
                  <!-------------------------------------------- DISBURSEMENT ------------------------------------------->
                  <li class = "<?php if($menuchecker['dv_update'] || $menuchecker['dv'] || $menuchecker['dv_create'] || $menuchecker['dv_process']) echo 'active';?>"><a href="accounting_disbursement.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>DISBURSEMENT</a></li>
                  <!-------------------------------------------- DISBURSEMENT ------------------------------------------->
                  <?php endif ?>
              ...
              <li class="treeview <?php if($menuchecker['nta_obligation'] || $menuchecker['nta_obcreate']) echo 'active';?>"> 
                ...
                <!-------------------------------------------- PAYMENT ------------------------------------------->
                  ...
                  <li class = "<?php if($menuchecker['nta_obligation'] || $menuchecker['nta_obcreate']) echo 'active';?>"><a href="cash_payment.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>PAYMENT</a></li>

                 <!--  <li class = "<?php if($menuchecker['nta_obligation'] || $menuchecker['nta_obcreate']) echo 'active';?>"><a href="error_500.php?division=<?php echo $param1;?>" ><i class="fa" >&#xf0f6;</i>PAYMENT</a></li> -->
                <!-------------------------------------------- PAYMENT ------------------------------------------->
                  <?php endif ?>
              ...
              <!-------------------------------------------- TRAVEL CLAIM ------------------------------------------->
              <li class = "<?php if($menuchecker['travel_claim']) echo 'active';?>"><a href="CreateTravelClaim.php?username=<?php echo $param2;?>&division=<?php echo $param1;?>" ><i class="fa fa-folder-open-o" ></i>Travel Claim</a></li>
              <!-- <li class = "<?php// if($menuchecker['payroll'] || $menuchecker['payroll_update']  ) echo 'active';?>"><a href="PayrollEmployee.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  ><i class="fa fa-user" ></i>Payroll</a></li> -->
              <!-------------------------------------------- TRAVEL CLAIM ------------------------------------------->
              <?php endif ?>

              <!-- UNCOMMENT WHEN MODULE IS READY -->
              <li class = "<?= $menuchecker['funds_downloaded'] ? 'active' : '';?>"><a href="funds_downloaded.php?division=<?= $_SESSION['division'];?>" ><i class="fa fa-folder-open-o" ></i>Funds Downloaded</a></li>

              <!-- <li class = "<?= $menuchecker['funds_downloaded'] ? 'active' : '';?>"><a href="error_500.php?division=<?= $_SESSION['division'];?>" ><i class="fa fa-folder-open-o" ></i>Funds Downloaded</a></li> -->
              ...
              <?php if ($username == 'masacluti' || $username == 'mmmonteiro' || $username == 'seolivar'): ?>
                <li class="treeview <?php if( $link == 'http://fas.calabarzon.dilg.gov.ph/ViewEmployee.php?division='.$param5.'' || $link == 'http://fas.calabarzon.dilg.gov.ph/ViewRetireEmployee.php?division='.$param5.'' || $link == 'http://fas.calabarzon.dilg.gov.ph/ViewResignEmployee.php?getntano='.$_GET['getntano'].'&getparticular='.$_GET['getparticular'].'' || $link == 'http://fas.calabarzon.dilg.gov.ph/ViewOnLeaveEmployee.php?division='.$param5.'' || $link == 'http://fas.calabarzon.dilg.gov.ph/nta.php?division='.$param5.'' || $link == 'http://fas.calabarzon.dilg.gov.ph/obligation.php?page=1&ipp=10' || $link == 'http://fas.calabarzon.dilg.gov.ph/saroupdate.php?getid='.$_GET['getid'].'' || $link == 'http://fas.calabarzon.dilg.gov.ph/obupdate.php?getid='.$_GET['getid'].'' || $link == 'http://fas.calabarzon.dilg.gov.ph/sarocreate.php' || $link == 'http://fas.calabarzon.dilg.gov.ph/obtableViewMain.php?getsaroID='.$_GET['getsaroID'].'&getuacs='.$_GET['getuacs'].'' ){ echo 'active'; } ?>" >
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu" >
                      <li><a href="ViewEmployee.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> Employee List </a></li>
                      <li><a href="ViewRetireEmployee.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> Retire Employees</a></li>
                      <li><a href="ViewResignEmployee.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> Resign Employees</a></li>
                      <li><a href="ViewOnLeaveEmployee.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" ></i> On Leave Employees</a></li>
                    </ul>
                  </li>
                </li>

                <li><a href="ViewDeduction.php?username=<?php echo $param2;?>&division=<?php echo $param1;?>" ><i class="fa fa-folder-open-o" ></i>Manage Allowances</a></li>
                <li><a href="ViewGeneratePayroll.php?username=<?php echo $param2;?>&division=<?php echo $param1;?>" ><i class="fa fa-folder-open-o" ></i>Generate Payroll</a></li>
                <li><a href="CreateLoans.php?username=<?php echo $param2;?>&division=<?php echo $param1;?>" ><i class="fa fa-folder-open-o" ></i>Create Loan</a></li>
                <!-- <li><a href="PayrollEmployee.php?division=<?php echo $param1;?>&username=<?php echo $username;?>"  style = "color:black;font-weight:normal;"><i class="fa fa-user" ></i>Update Payroll Emp</a></li> -->
                </ul>
          ...
          <li class="treeview <?php if ($menuchecker['qms_statistics'] || $menuchecker['qms_procedures'] || $menuchecker['qms_process_owners']) echo 'menu-open active'; ?>">
            ...
            <ul class="treeview-menu <?php if($menuchecker['setting'] || $menuchecker['approval']) echo 'active';?>">
              ...
              <?php if ( in_array(47, $arrayModuleId) ) : ?>
              <!-------------------------------------------- USER MANAGEMENT ------------------------------------------->
              <li class = "<?php if($menuchecker['setting']) echo 'active';?>"><a  href="Accounts.php"><i class = "fa fa-fw fa-user-md" ></i>User Management</li>
              <!-------------------------------------------- USER MANAGEMENT ------------------------------------------->
              <?php endif ?>  

              <?php if ( in_array(47, $arrayModuleId) ) : ?>
              <!-------------------------------------------- FOR APPROVAL ------------------------------------------->
              <li class = "<?php if($menuchecker['approval']) echo 'active';?>"><a  href="Approval.php"><i class = "fa fa-fw fa-check-square-o" ></i>For Approval</li>
              <!-------------------------------------------- FOR APPROVAL ------------------------------------------->
              <?php endif ?>  
