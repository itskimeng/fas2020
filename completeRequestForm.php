      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan=3 style="  padding:5px 5px 5px 5px;">
            ...
            <input type="text" class="sizeMax alphanum subtxt" id="client" value=" <?php $assist_by = ucwords(strtolower($row['REQ_BY']));
                                                                                    echo $assist_by; ?>" disabled />
        ...
        <div class="panel panel-default">
          <div class="box-body">
            ...
            <form method="POST" enctype="multipart/form-data" class="myformStyle" autocomplete="off" id="submit">
              ...
              <?php include 'ict/views/complete_table_footer.php'; ?>
