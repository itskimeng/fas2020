...
<html>
  ...
  <link rel="shortcut icon" type="image/png" href="dilg.png">
    ...
    <link rel="stylesheet" href="bower_components/icheck-1.0.3/skins/square/red.css">
...
<div class="wrapper">
    ...
    <?php include('FiveSMonitoringForm/views/driver_edit_form.html.php'); ?>
    <!-- end separate -->
</div>
...
<script src="bower_components/icheck-1.0.3/icheck.min.js"></script>
