 ...
 $(document).ready(function() {
    ...
    $(add_button).click(function(e) {
      ...
      if (x < max_fields) {
        x++;
        var list = "Hello";
            $(wrapper).append('<div ><br><br><br><br><a href="#" style="margin-right:50px" class="delete btn btn-danger btn-xs pull-right"><i class="fa fa-trash-o"></i></a><br><br><div class="col-md-3"><tr><td class="col-md-1"><b style="font-size: 12px;">CHARGE TO:</b></td><td class="col-md-7"><select class="form-control select" name="charge[]" id="charge" required > <option value = "">Select NCA/NTA</option> <option value = "NCA">NCA</option> <option value = "NTA">NTA</option> </select> </td> </tr> </div> <div class="col-md-4"> <tr> <td class="col-md-1"><b style="font-size: 12px;">NCA/NTA NO:</b></td> <td class="col-md-7">  <select class="form-control select2" style= "color:black;text-align:center;"  id = "ntano" name="ntano[]"> <?php getNta();?> </select>  </td> </tr> </div><div class="col-md-2"> <tr> <td class="col-md-1"><b style="font-size: 12px;">AMOUNT:</b></td> <td class="col-md-7"> <input required value=""  class="form-control input" type="number" step="any"  class="" id="ntaamount" name="ntaamount[]" placeholder="0" autocomplete="off"> </td> </tr> </div>  <div class="col-md-3"> <tr> <td class="col-md-1"><b style="font-size: 12px;">NCA/NTA BALANCE</b></td> <td class="col-md-7"> <input readonly value=""  class="form-control input" type="text"  class="" id="ntabalance" name="ntabalance" placeholder="0" autocomplete="off"> </td> </tr> </div></div>'); //add input box
          } else {
