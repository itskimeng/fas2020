<?php require_once 'Finance/controller/ObjectCodesController.php'; ?>
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb"> 
          ...
          <li>Finance</li>
          <li><a href="budget_fundsource.php"> Budget Section</a></li>
          <li class="active">Object Codes</li>
        </ol> 
    </section>
    
    <section class="content">
      <div class="row">
        <?php include('Finance/views/BudgetFundSource/obc_table.php'); ?>
      </div> 
    </section>
</div>

<?php include('Finance/views/BudgetFundSource/modal_object_codes.php'); ?>
...
<script type="text/javascript">
  ...
  var table = $('#example').DataTable({
    ...
    "columns": [
      ...
      { "data": "object_code", "width": "15%" },
      { "data": "uacs", "width": "15%", "className": 'text-center' },
