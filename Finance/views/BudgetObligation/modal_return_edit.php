<div class="modal fade-scale" id="modal_return_edit_obligation" tabindex="-1" role="dialog" aria-labelledby="edit_modalLabel" aria-hidden="true">
    ...
    <form method="GET" action="Finance/route/update_obligation_status.php?" >
      <div class="modal-content delete_modal" style="border-radius:5px;">
        <div class="modal-header delete_modal_header text-center">
          ...
          <p>This action will return the selected Obligation <br><u><strong id="source_code" style="font-size:17px;"></strong></u>.</p>
        </div>
