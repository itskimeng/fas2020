                                        ...
                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                            ...
                                            <p style = "color:red;margin-top:-75%;font-weight:bold;">' . $row['STATUS_REQUEST'] . '</p>
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <!-- <span class="info-box-number pull-right" style = "margin-top:-15px;"><a href = "_editRequestTAuser.php?division=<?php //echo $_GET['division'];
                                                                                                                                                                            ?>&id=<?php //echo $row['CONTROL_NO'];
                                                                                                                                                                                                                ?>">Edit</a> -->
                                                    </span>
...
function showWorkload($ICT)
{
  ...
  where `ASSIST_BY` != '' ";
    ...
    <body class="hold-transition skin-red-light fixed sidebar-mini">
        <div class="wrapper">
            <?php
            if ($username == 'charlesodi' || $username == 'mmmonteiro' || $username == 'cvferrer' || $username == 'masacluti' || $username == 'magonzales' || $username == 'seolivar' || $username == 'ctronquillo' || $username == 'sglee') {
                include('test1.php');
            } else {
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="panel panel-default">
                                    <div class="box-body">
                                        <div>
                                            <h1>Processing of ICT Technical Assistance</h1><br>
                                        </div>
