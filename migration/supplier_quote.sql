...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2022 at 10:24 AM
...
INSERT INTO `supplier_quote` (`id`, `supplier_id`, `rfq_no`, `rfq_id`, `rfq_item_id`, `ppu`, `remarks`, `is_winner`) VALUES
(1, 920, '2022-0001', 0, 951, 250, '', '1'),
(2, 920, '2022-00002', 0, 951, 268, '', ''),
(3, 903, '2022-00002', 2, 951, 4, '', '');
