              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <?php if ($pr_date == '') : ?>
                      <input required type="text" class="form-control pull-right" name="pr_date" id="datepicker1" value="<?php $now = date("m/d/Y");
                                                                                                                          echo $now;  ?>">
                    <?php else : ?>
                      <input required type="text" class="form-control pull-right" name="pr_date" id="datepicker1" value="<?php $now =  date("m/d/Y");
                                                                                                                          echo $now;  ?>">
                ...
                <table style="background-color: white;border-width: medium;" class="table " id="item_table">
                  ...
                  <tr>
                    ...
                    ?>
                      ...
                      <td><?php $ans = $abc1 * $qty1;
                          echo $ans; ?></td>
                      <td hidden><input hidden type="text"  value="<?php echo $description1 ?>"><?php echo $description1 ?></td>
                      <td>
