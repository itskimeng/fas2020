...
if (isset($_POST['submit'])) {
  ...
  if (!ifRecordExist($sqlEMP_N)) {
    $sql_insert_query = mysqli_query($conn, "INSERT INTO tblemployeeinfo( EMP_NUMBER, LAST_M, FIRST_M, MIDDLE_M, BIRTH_D, SEX_C, REGION_C, PROVINCE_C, CITYMUN_C, POSITION_C, DESIGNATION, MOBILEPHONE, EMAIL, ALTER_EMAIL, UNAME, DATE_CREATED, LANDPHONE, OFFICE_STATION, DIVISION_C, PROFILE, SUFFIX, CIVIL_STATUS, ACTIVATED, REMARKS_M, CURRENT_ADDRESS, PERMANENT_ADDRESS, STATUS_OF_APP, `GENERATION`, `AWARDS`, `HEA`, `Q1`, `Q2`, `Q3`, `Q4`, `YEARS _IN_SERVICE`)
        VALUES ('$employee_number','$lname', '$fname', '$mname', '$birthdate', '$gender', '$region', '$province', '$municipality', '$position', '$designation', '$cellphone', '$email', '$alter_email','$username', '$date_created', '$office_contact', '$office', '$division','$target_file','$suffix','$status','$e_stats','$office_address','$current_address','$permanent_address', '$office_landline','$generation','$awards','$education_attainment','$children_below_6','$indigenous_group','$pwd','$solo_parent','$years_inservice')");
    if ($e_stats == 'Yes') {
      if ($province == '') {
        $province = 77;
      }
    ...
    if ($sql_insert_query) {
      ...
      echo ("<SCRIPT LANGUAGE='JavaScript'>
      window.alert('Error Occured Uppon Saving!'" . $sql_insert_query . "');
      </SCRIPT>");
    }
  } else {
    echo ("<SCRIPT LANGUAGE='JavaScript'>
...
<div class="box box-success">
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="" style="background-image: url(images/LOGO.png);background-repeat: no-repeat;background-position: center;">
        <div class="box-header with-border">
          <div class="pull-left">
            <div class="center">
              <img id="img" style="overflow: hidden;width:300;height:250px;margin-left:50px;border:2px solid black;" src="images/male-user.png" title="personnel_image" />
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="generation" class="form-control" style="height: 105px;resize:none;"></textarea>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label>Awards Received<font style="color:red;">*</font></label>
                <textarea name="awards" class="form-control" style="height: 105px;resize:none;"></textarea>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control select2" name="education_attainment">
                ...
                <option value="Professional Degree">Professional Degree (e.g. Law, Medicine)</option>
                <option value="Technical or Vocational Degree">Technical or Vocational Degree</option>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="number" name="years_inservice" class="form-control" placeholder="Years in the Department">
            </div>
          </div>
  ...
  <div class="row">
    <div class="col-xs-2" align="center">
      <button class="btn btn-block btn-primary" name="submit" type="submit" id="submit">
        <font size="">Save</font>
      </button>
    </div>
  </div>
