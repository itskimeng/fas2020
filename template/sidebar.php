function menuOption($title,$url,$icon,$param1,$param2,$param3,$param4,$param5,$param6,$username,$link,$active)
{
  $active = checkMenu($active);
    ...
    switch ($title) {
        ...
        case 'Calendar':
            ...
            ?>
            <li class = "<?php if($active['Calendar']) echo 'active';?>">
                <a href="<?php echo $url;?>">
        ...
        case 'HR Section':
            ?>
              <li class ="treeview <?php if( $active['ViewEmployees.php'] || $active['CreateEmployee.php'] || $active['UpdateEmployee.php'] || $active['DTRa.php'] || $active['DTR.php'] || $active['DtrMonitoring.php'] || $active['ROandROO.php'] || $active['ob.php'] || $active['OfficialBusinessCreate.php'] || $active['OfficialBusinessUpdate.php'] || $active['TravelOrder.php'] || $active['TravelOrderCreate.php'] || $active['TravelOrderUpdate.php'] || $active['HealthMonitoring.php'] )echo "active" ?>") >
                <a  href="#" >
                  <i class="<?php echo $icon;?>" style = "color:black;"></i> 
                  <span  style = "color:black;font-weight:normal;"><?php echo $title;?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span>
                </a>
        ...
        case 'GSS Section':
          ?>
            <li class ="treeview <?php if($active['GSS']) echo 'active'; ?> " >
              <a  href="#" >
