                ...
                <tr style="height:51px;">
                  ...
                  <td>
                    <?php if (count($check1)>0): ?>
                      <?php echo date('h:i A',strtotime($check1['time_in']))?></td>
                    <?php else: ?>
                ...
                <tr style="height:51px;">
                  ...
                  <td>
                    <?php if (count($check2)>0): ?>
                      <?php echo date('h:i A',strtotime($check1['lunch_in']))?>
                    <?php else: ?>
                ...
                <tr style="height:51px;">
                  ...
                  <td>
                    <?php if (count($check3)>0): ?>
                      <?php echo date('h:i A',strtotime($check1['lunch_out']))?>
                    <?php else: ?>
                ...
                <tr style="height:51px;">
                  ...
                  <td>
                    <?php if (count($check4)>0): ?>
                      <?php echo date('h:i A',strtotime($check1['time_out']))?>    
                    <?php else: ?>
