    ...
    <form method="POST" action="calendar/add-event.php">
        ...
        <table class="table table-bordered" style="width:100%;">
            ...
            <tr>
                ...
                <td class="col-md-5">
                    <input disabled type="text" class="form-control datepicker2" id="datepicker2" name="enddatetxtbox" placeholder="mm/dd/yyyy" autocomplete=off />
                </td>
            </tr>
            <tr>
    ...
    <form method="POST" action="calendar/edit-event.php" id="edit_act">
        ...
        <table class="table table-bordered" style="width:100%;">
            ...
            <tr>
                <td class="col-md-2" style="font-weight:bold">End Date</td>
                <td class="col-md-5">
                    <input autocomplete="off" type="text" class="form-control end" name="end" id="end" value="" />
                </td>
            </tr>
            <tr>
                <td class="col-md-2" style="font-weight:bold">Description</td>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage All Activities</li>
                </ol>
