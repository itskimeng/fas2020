        ...
        <div class="col-lg-3">
          <div class="box box-warning dropbox">
            <div class="box-header">
              <h3 class="box-title" style="color:black!important;"><i class="fa fa-graph"></i>ICT Staff Work Load</h3>
            </div>
          ...
          <button id="btn_create" class="btn-lg col-lg-12 btn-default" style="background:linear-gradient(90deg,#64B5F6,#0D47A1);color:#fff;">Create ICT Request</button>
        </div>
        <div class="col-lg-9">
