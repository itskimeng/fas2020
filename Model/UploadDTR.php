...
class UploadDTR extends Connection
{ 
    private $default_table = 'tbl_upload_dtr';

    const TYPE_FIRST_CUTOFF         = "1";
    const TYPE_SECOND_CUTOFF        = "2";
    const TYPE_SCAN_FACIAL          = "1";
    const TYPE_SCAN_FINGERPRINT     = "2";
