...
<?php $menuchecker = menuChecker('nta_create'); ?>
<!DOCTYPE html>
<html>
<!-- <style>
  a:hover {
...
<?php 
  if ($username == 'aoiglesia' || $username == 'mmmonteiro' || $username == 'cvferrer' || $username == 'masacluti' || $username == 'magonzales' || $username == 'seolivar' || $username == 'jamonteiro' || $username == 'ctronquillo' || $username == 'rlsegunial') { include('test1.php'); }else{ include('sidebar2.php'); }
 ?>
