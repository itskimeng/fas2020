                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div id="cgroup-source_no" class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?= 'Client Type'; ?>" />
                                            </div>
                                            <div id="cgroup-source_no" class="form-group">
                                            ...
                                            <div id="cgroup-source_no" class="form-group">
                                                ...
                                                <input type="text" class="form-control col-lg-12" readonly value="<?= 'Region of Residence'; ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div id="cgroup-source_no" class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div id="cgroup-source_no" class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?= 'cc1'; ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <input id="cform-source_id" class="source_id" type="hidden" name="source_id" value="107">
                                            <div id="cgroup-source_no" class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?= 'cc2'; ?>" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <input id="cform-source_id" class="source_id" type="hidden" name="source_id" value="107">
                                            <div id="cgroup-source_no" class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value="<?= 'cc3'; ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($css_opts as $key => $item) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%;">
                                                        <center><input <?php echo ($checklist['checklist0'] == 4) ? 'checked' : ''; ?> type="checkbox" name="rating[]" value="4" id="chk_list" class="chk_list sqd<?= $key; ?> form-check-input" /> </center>
                                                    </td>
                                                    <td style="width: 5%;">
                                                        <center><input <?php echo ($checklist['checklist2'] == 3) ? 'check' : ''; ?> type="checkbox" name="rating[]" value="3" id="chk_list" class="chk_list sqd<?= $key; ?> form-check-input" /> </center>
                                                    </td>
                                                    <td style="width: 5%;">
                                                        <center><input <?php echo ($checklist['checklist3'] == 2) ? 'check' : ''; ?> type="checkbox" name="rating[]" value="2" id="chk_list" class="chk_list sqd<?= $key; ?> form-check-input" /> </center>
                                                    </td>
                                                    <td style="width: 5%;">
                                                        <center><input <?php echo ($checklist['checklist4'] == 1) ? 'check' : ''; ?> type="checkbox" name="rating[]" value="1" id="chk_list" class="chk_list sqd<?= $key; ?> form-check-input" /> </center>
                                                    </td>
                                                    <td style="width: 5%;">
                                                        <center><input <?php echo ($checklist['checklist5'] == 0) ? 'check' : ''; ?> type="checkbox" name="rating[]" value="0" id="chk_list" class="chk_list sqd<?= $key; ?> form-check-input" /> </center>
                                                    </td>
                                            ...
                                            function category($pointer)
                                            {
                                                ...
                                                if (array_key_exists($pointer, $sq)) {
                                                    $sq[$pointer] = 'yes';
                                                }
                                                return $sq;
                                            }
