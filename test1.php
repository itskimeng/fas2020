                  ...
                  <ul class="treeview-menu">
                    <li class="treeview <?php if( $menuchecker['saro'] || $menuchecker['ors_burs'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create'] || $menuchecker['view_burs']) echo 'menu-open active';?>">
                      ...
                      <ul class="treeview-menu <?php if($menuchecker['finance_fundsource'] || $menuchecker['ors_burs'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create']) echo 'menu-open active';?>">
                        ...
                        <!-------------------------------------------- SARO/SUB-ARO ------------------------------------------->
                        <li class = "<?php if($menuchecker['fund_source'] || $menuchecker['saro_create'] || $menuchecker['saro_update'] || $menuchecker['ob_view'] || $menuchecker['ob_create']) echo 'active';?>"><a href="saro.php?division=<?php echo $param1;?>" ><i class="fa fa-copy" style = "color:black;"></i> SARO/SUB-ARO </a></li>
