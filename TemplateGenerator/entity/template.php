...
foreach ($attendees as $attendee) {
    ...
    is hereby awarded to<br><br><br><br><div style="font-family:helvetica;font-weight:bold;font-size:26pt; text-align:center;">'.$attendee.'</div><br><br><div style="font-family:Verdana Regular;font-size:12pt; text-align:center;">in recognition for his/her active paritcipation during the conduct of the <b>'.$activity_title.'</b><br>Given this <b>'.$date_given_day.'</b> of <b>'.$date_given_my.'</b></div>
    </div>';
