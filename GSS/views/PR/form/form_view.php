        ...
        <form id="form_pr_item">
            <div class="row">
                ...
                <p>
                    ...
                    <button type="button" id="modalButton" class="btn btn-primary pull-right " value="/documentroute/createreject?routeno=1751014&amp;docno=R4A-2021-07-27-001&amp;receivedfrom=1551&amp;userid=8516"><i class="fa fa-file-excel-o"></i> EXPORT PR</button>
                </p>
