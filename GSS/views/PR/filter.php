<div class="row filter_buttons fadeInDown" style="display:none;">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="box-body box-emp">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group"><label class=" control-label">Quarter:</label><br>
                            <select id="cform-filter_quarter" name="filter_month"
                                class="form-control select2 filter_month" data-placeholder="-- Select Month --"
                            ...
                            <input type="hidden" name="hidden-filter_month" value="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group"><label class=" control-label">Office:</label><br>
                            <select id="cform-filter_office" name="filter_payee"
                                class="form-control select2 filter_payee" data-placeholder="-- Select Payee --"
                                required="1" style="width:100%;">
                            ...
                            <input type="hidden" name="hidden-filter_payee" value="">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group" style="margin-top:4px;">
                            ...
                            <div class="btn-group">
                                <button type="button" id="btn-search" value="close"
