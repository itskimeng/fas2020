<?php
action_button($data,$username,$admin,$_GET['division'])
...
//       if($data['stat'] == 7 || $data['stat'] == 5 )
//       {
//         echo '<button id="btn_submit_to_gss" value="' . $data['pr_no'] . '" disabled class="btn btn-primary btn-sm btn-view" title="Submit to GSS"> <i class="fa fa-send"></i></button>  ';
...
//   echo '<button id="btn_submit_to_gss" disabled="" class="btn btn-primary btn-sm btn-view" title="Submit to GSS" value="2022-05-0182"> <i class="fa fa-send"></i></button>';
//   echo '&nbsp;<button id="sweet-4"  class="btn btn-warning btn-sm btn-view" title="Cancel this PR" value="' . $data['pr_no'] . '"> <i class="fa fa-times-circle"></i></button>  ';
