<div class="modal fade" id="rfq_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box box-primary hideme"
                                    style="height: 302px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control pull-right"
                                                    value="<?= $rfq_no['rfq_no'];?>" name="rfq_no">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control form-control" data-placeholder="-- Select  --" required="1" style="width:100%;" name="mode">
                                                        ...
                                                        <option value="1" data-id="Small Value Procurement"
                                                            data-value="1">Small Value Procurement</option>
                                            ...
                                            <div class="bootstrap-timepicker">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="datepicker-group"
                                                        ...
                                                        <input type="text" class="form-control pull-right info-dates"
                                                            id="datepicker1" name="rfq_date">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <!-- /.form group -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="particulars"
                                                    style="width: 406px; height: 190px;resize:none;"></textarea>
    ...
    $('#multiple_rfq').on('submit', function(e) {
        ...
        $.post({
            ...
            success: function(data) {
                toastr.success(
                    "This item was successfully copied into your purchasing table.");
                    location.reload();
            }
        })
