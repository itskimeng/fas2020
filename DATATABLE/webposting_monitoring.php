...
if($row = mysqli_fetch_array($result))
{
	...
	$uname    = $row['UNAME'];
		...
		$fieldsName = '`ID`, `CONTROL_NO`, `REQUESTED_DATE`, `REQUESTED_TIME`, `REQUESTED_BY`, `OFFICE`, `POSITION`, `MOBILE_NO`, `CATEGORY`, `PURPOSE`, `ATTACHMENT`, `RECEIVED_DATE`, `RECEIVED_TIME`, `POSTED_DATE`, `POSTED_TIME`, `POSTED_BY`, `REMARKS`, `CONFIRMED_DATE`, `CONFIRMED_TIME`, `CONFIRMED_BY`, `IS_APPROVED`, `STATUS`';
		$table = 'tblwebposting';
		$join = '';
		$WHERE = '';
