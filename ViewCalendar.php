...
require_once 'fetchcalData.php';
$menuchecker = menuChecker('calendar');
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="height:40px;background-image: linear-gradient(#ffebee, #ffcdd2, #ef9a9a);">
              <h4 class="modal-title">
                Conflict Details
                <small><i class="fa fa-info-circle"></i>Reminder from DILG IV-A:</small>
              </h4>
